...
public class Loader {
	...
	static {
		...
		String ignoreTCLProp = OptionConverter
				.getSystemProperty("log4j.ignoreTCL", null);
	...
	static public URL getResource(String resource) {
		...
		try {
			...
			if (t.getTargetException() instanceof InterruptedException || t
	 ...
	 * <code>null<code>. TCL的含义：Thread Context Loader 这是反射中非常重要的一个认识。 可以当做放射认识一
	 */
